        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`text-center p-6 rounded-xl border border-slate-200 bg-white hover:border-slate-300 transition-colors animate-fade-up delay-${(index + 1) * 150}`}
              >
                <div className="flex justify-center mb-4">
                  <div className="w-16 h-16 bg-linear-to-br from-blue-100 to-slate-100 rounded-full flex items-center justify-center">
